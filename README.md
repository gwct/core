...
16. supertreemaker.py
  * This script can do several things. Runs SDM to get average consensus distance matrices, make NJ trees from distance matrices (with R), re-roots trees (with newickutils), and makes ultrametric trees (with r8s). All of these programs will need to be in your PATH.
