...
parser.add_argument("-m", dest="model", help="The Hyphy model that was used to generate the files in -i. Default: mg94, mg94-local, busted", default="mg94");
...
if args.model not in ["mg94", "mg94-local", "busted"]:
    sys.exit(" * Error 2: Model (-m) must be one of: mg94, mg94-local, busted");
