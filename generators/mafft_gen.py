...
output_file = os.path.join(cwd, "jobs", "mafft_cmds_" + name + ".sh");
submit_file = os.path.join(cwd, "submit", "mafft_submit_" + name + ".sh");
...
# Generating the commands in the job file.
    ...
    for f in os.listdir(args.input):
        ...
        mafft_cmd = args.path + " " + cur_infile + " 2> " + cur_logfile + " 1> " + cur_outfile;
